      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-border bg-card p-6">
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-3 rounded-full border border-border bg-background px-4 py-2.5 text-sm font-medium text-foreground hover:bg-secondary transition-colors"
          >
